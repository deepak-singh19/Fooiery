  ...
  return (
    <section className=" grid grid-cols-1 md:grid-cols-2 gap-2  w-full "  id="home">
      ...
      <div className="py-2  flex-1 flex items-center relative ">
            ...
            <div className="w-full h-full absolute  top-0 left-0 flex items-center justify-center  md:px-32 gap-4 flex-wrap py-4">
                ...
                {HeroData && HeroData.map(n =>(
                    ...
                    <img src={n.imageSrc} className=" w-20 lg:w-40 -mt-10lg:-mt-20 "  alt="I1"/>
